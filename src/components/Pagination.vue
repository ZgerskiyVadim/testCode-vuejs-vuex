...
<script>
    export default {
        computed: {
            current() {return this.$store.state.vacanciesModule.currentPage},
            pageRanger() {return this.$store.state.vacanciesModule.pageRanger},
            pageRange() {return this.$store.state.vacanciesModule.pageRange},
            total() {return this.$store.state.vacanciesModule.totalPage},
            perPage() {return this.$store.state.vacanciesModule.perPage},
            pages: function() {
                var pages = [];
